...
$mycategory = DB::getRow("SELECT *From category WHERE seo='".$_GET['seo']."'");
...
//                                                      WHERE b.art_id=a.id AND b.category_id='$mycategory->id'";
                $all_arts = DB::get("SELECT a.id,a.liked,a.disliked,a.comment,a.title,a.user_id,a.url,a.mime,a.size FROM art as a, 
                                      category_art_relation as b 
                                      WHERE a.share=1 AND b.art_id=a.id AND b.category_id='$mycategory->id'");
