            ...
            <section class="content">
                ...
                <div class="row">
                    <?php
                        ...
                        $all_arts = DB::get("SELECT *FROM all_shared_arts");
                            ...
                            if(startsWith($art->mime,'image')) {
                                echo '<div class="col-md-4 my_art" style=";max-heght:400px;min-height: 400px;margin-bottom: 5px">
                                        <div class="my_art" style="padding: 10px;border: 1px solid white;max-heght:400px;min-height: 400px;">
                                            <a href="'.BASE_URL.'/art-detail/'.$art->id.'"><img class="image" src="'.BASE_URL.'/'. $art->url . '" style="width:100%;max-height:350px;padding-bottom: 10px;"></a>
                                            ...
                                            <div class="art" style="display:none">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <span style="color:#f39c12;font-size:x-large;">';
                                                        ...
                                                        {
                                                            if($user->authority =='admin' || $user->authority == 'moderator'|| $user->id == $art->user_id)
                                                            {
                                                               echo  '<a href="'.BASE_URL.'/edit-art/'.$art->id.'"><i class="fa fa-edit bg-yellow"></i></a></span>';
                                                     ...
                                                     echo   '<i class="fa fa-comments bg-yellow"></i>'.$art->comment.'</span>
    ...
    <script>
        ...
        if(isset($_SESSION["auth_user"]))
            ...
            $("body").on("click",".fa-thumbs-o-up,.fa-thumbs-o-down",function (e) {
                ...
                e.preventDefault();
                $.ajax({
                    url : "like-dislike-art", // the endpoint
